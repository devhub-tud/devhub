						...
						<div class="panel-body">
							...
							<form role="form" id="login-form" method="POST" action="">
								<div class="form-group">
									...
									<input type="text" value="student1" id="netID" name="netID" class="form-control" autofocus="autofocus" placeholder="${i18n.translate("form.login.net-id.label")}">
								</div>
								<div class="form-group">
									<label for="password">${i18n.translate("form.login.password.label")}</label>
									<input type="password" value="student1" id="password" name="password" class="form-control" placeholder="${i18n.translate("form.login.password.label")}">
								</div>
								<div class="form-group">
